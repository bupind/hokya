							...
							<div class="table-responsive">
								<table class="table table-striped table-hover table-setting">
									...
									<tr>
										...
										<td class="link-setting">
											<a href="javascript:void(0)" id="google_analytics" data-type="text" data-pk="19" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[18]['value'];?></a>
										</td>
									</tr>
									<tr>
										<td style="width:265px;"><?=$GLOBALS['_']['setting_recaptcha_sitekey'];?></td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="recaptcha_sitekey" data-type="text" data-pk="20" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[19]['value'];?></a>
										</td>
									</tr>
									<tr>
										<td style="width:265px;"><?=$GLOBALS['_']['setting_recaptcha_secretkey'];?></td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="recaptcha_secretkey" data-type="text" data-pk="21" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[20]['value'];?></a>
										</td>
									</tr>
<!--									<tr>-->
							...
							<div class="table-responsive">
								<table class="table table-striped table-hover table-setting">
									<tr>
										...
										<td class="link-setting">
											<a href="javascript:void(0)" id="mail_protocol" data-type="select" data-pk="22" data-url="route.php?mod=setting&act=edit" data-value="<?=$settings[21]['value'];?>" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[21]['value'];?></a>
										</td>
									</tr>
									<tr>
										<td style="width:265px;"><?=$GLOBALS['_']['setting_mail_hostname'];?></td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="mail_hostname" data-type="text" data-pk="23" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[22]['value'];?></a>
										</td>
									</tr>
									<tr>
										<td style="width:265px;"><?=$GLOBALS['_']['setting_mail_username'];?></td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="mail_username" data-type="text" data-pk="24 data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[23]['value'];?></a>
										</td>
									</tr>
									<tr>
										<td style="width:265px;"><?=$GLOBALS['_']['setting_mail_password'];?></td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="mail_password" data-type="text" data-pk="25" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[24]['value'];?></a>
										</td>
									</tr>
									<tr>
										<td style="width:265px;"><?=$GLOBALS['_']['setting_mail_port'];?></td>
										<td class="link-setting">
											<a href="javascript:void(0)" id="mail_port" data-type="number" data-pk="26" data-url="route.php?mod=setting&act=edit" title="<?=$GLOBALS['_']['setting_edit_tooltip'];?>"><?=$settings[25]['value'];?></a>
										</td>
									</tr>
								</table>
							</div>
