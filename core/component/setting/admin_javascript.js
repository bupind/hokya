 ...
 *
 *
 * Ini adalah file utama javascript eska yang memuat semua javascript di pengaturan.
 * This is a main javascript file from eska which contains all javascript in setting.
 *
*/
...
$(document).ready(function() {
	...
	function getJsonCountry(){
		var arr = [];
		$.getJSON("../inc/core/json/country.json", function(data) {
	...
	function getJsonRegion(country){
		...
		$.getJSON("../inc/core/json/region/"+country+".json", function(data) {
	...
	function getJsonTimezone(){
		var arr = [];
		$.getJSON("../inc/core/json/timezone.json", function(data) {
			$.each(data, function(key, val) {
				arr.push({
					value: val.value,
					text: val.text
