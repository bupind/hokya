        ...
        <div class="row">
            ...
            if ($notif_contact > 0) {
                ...
                <div class="col-md-12">
                    <div class="widget">
                        <div class="mini-stats">
                            <a href="admin.php?mod=contact"><span class="bg-primary"><i
                    ...
                    <div class="popular-post">
                        <div class="widget-title">
                            ...
                            <script type='text/javascript'
                                    charset='utf-8'>if (typeof vfxIdx === 'undefined') vfxIdx = 0;
                                vfxIdx++;
                                document.write("<div id='vfxWidget" + vfxIdx + "'><" + "/div>");
                                document.write("<script async type='text/javascript' src='https://widgets.valutafx.com/ConverterWidgetLoader.aspx?sid=CC002NQSZ&idx=" + vfxIdx + "' charset='utf-8'></" + "script>");</script>
                            <div style='overflow: hidden;'>
                                <div style='float:left; text-align: left;'>
                                    <noindex><a title='' style='font-size:12px;color:#007EAA;text-decoration: none;'
                                                href='https://id.valutafx.com/AddConverter.aspx?sid=CC002NQSZ'
                                                target='_blank' rel='nofollow'>Tambahkan ke situs</a></noindex>
                                </div>
                                <div style='float:right; text-align: right;'><a
                                            style='font-size:12px;color:#777777;text-decoration: none;opacity: 0.6;filter: alpha(opacity=60);'
                                            href='https://id.valutafx.com/' target='_blank'>id.valutafx.com</a></div>
                            </div>
                    ...
                    <div class="stats">
                        <div class="widget-title">
                            ...
                            <span>
								<i class="fa fa-circle"
                                   style="color:#DCDCDC;"></i> <?= $GLOBALS['_']['home_visitors']; ?>
                        ...
                        <div class="pull-right text-right" style="margin-top:-60px;">
                            <form class="form-inline" action="admin.php?mod=home" method="post">
                                ...
                                <a href="admin.php?mod=home&act=statistics" class="btn btn-sm btn-success"
                                   title="<?= $GLOBALS['_']['home_summary']; ?>"><i class="fa fa-line-chart"></i></a>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-md-12 text-center">
                    <form class="form-inline" method="get" action="admin.php" autocomplete="off">
                        ...
                        <div class="form-group" style="border-bottom: none;">
                            <input type="text" name="from" class="form-control" id="from_stat"
                                   value="<?= (isset($_GET['from']) ? $_GET['from'] : ''); ?>"
                                   placeholder="<?= $GLOBALS['_']['home_from_date']; ?>" required/>
                        </div>
                        <div class="form-group" style="border-bottom: none;">
                            <input type="text" name="to" class="form-control" id="to_stat"
                                   value="<?= (isset($_GET['to']) ? $_GET['to'] : ''); ?>"
                                   placeholder="<?= $GLOBALS['_']['home_to_date']; ?>" required/>
                        </div>
                        <div class="form-group" style="border-bottom: none;">
                ...
                <div class="col-md-12">
                    <div class="pull-right" style="margin-top:10px;">
                        ...
                        <span><i class="fa fa-circle"
                                 style="color:#97BBCD;"></i> <?= $GLOBALS['_']['home_hits']; ?></span>
                    </div>
                    <div class="stats-desc">
                        <canvas id="canvas-stats"></canvas>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover">
                            <tr>
                                <th colspan="7"
                                    class="text-center text-uppercase"><?= $GLOBALS['_']['home_top_visitor']; ?></th>
                            </tr>
                            <tr>
                            ...
                            foreach ($visitors as $visitor) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span
                                                class="label label-info"><?= $visitor['hitstoday']; ?></span></td>
                                </tr>
                                <?php $novisitor++;
                            } ?>
                        </table>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover">
                            <tr>
                                <th colspan="3"
                                    class="text-center text-uppercase"><?= $GLOBALS['_']['home_top_browser']; ?></th>
                            </tr>
                            <tr>
                                <th class="text-center"><?= $GLOBALS['_']['home_number']; ?></th>
                                <th class="text-center"><?= $GLOBALS['_']['home_browser']; ?></th>
                            ...
                            foreach ($browsers as $browser) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span
                                                class="label label-success"><?= $browser['hitstoday']; ?></span></td>
                                </tr>
                                <?php $nobrowser++;
                            } ?>
                        </table>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover">
                            <tr>
                                <th colspan="3"
                                    class="text-center text-uppercase"><?= $GLOBALS['_']['home_top_platform']; ?></th>
                            </tr>
                            <tr>
                                <th class="text-center"><?= $GLOBALS['_']['home_number']; ?></th>
                                <th class="text-center"><?= $GLOBALS['_']['home_platform']; ?></th>
                            ...
                            foreach ($platforms as $platform) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span
                                                class="label label-danger"><?= $platform['hitstoday']; ?></span></td>
                                </tr>
                                <?php $noplatform++;
                            } ?>
                        </table>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover">
                            <tr>
                                <th colspan="3"
                                    class="text-center text-uppercase"><?= $GLOBALS['_']['home_top_country']; ?></th>
                            </tr>
                            <tr>
                                <th class="text-center"><?= $GLOBALS['_']['home_number']; ?></th>
                                <th class="text-center"><?= $GLOBALS['_']['home_country']; ?></th>
                            ...
                            foreach ($countrys as $country) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span
                                                class="label label-warning"><?= $country['hitstoday']; ?></span></td>
                                </tr>
                                <?php $nocountry++;
                            } ?>
                        </table>
                ...
                <div class="col-md-6 col-sm-6">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover">
                            <tr>
                                <th colspan="3"
                                    class="text-center text-uppercase"><?= $GLOBALS['_']['home_top_city']; ?></th>
                            </tr>
                            <tr>
                                <th class="text-center"><?= $GLOBALS['_']['home_number']; ?></th>
                                <th class="text-center"><?= $GLOBALS['_']['home_city']; ?></th>
                            ...
                            foreach ($citys as $city) {
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><span
                                                class="label label-info"><?= $city['hitstoday']; ?></span></td>
                                </tr>
                                <?php $nocity++;
                            } ?>
                        </table>
    ...
    public function error() {
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1 class="page-header">Page Not Found
                    <small class="text-danger">Error 404</small>
                </h1>
                <p>
