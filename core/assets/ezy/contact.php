					...
					<div class="container">
						...
						<div class="row pt-5">
									...
									<div class="col-12 col-md-4 col-lg-12 mb-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter">
										<div class="icon-box icon-box-style-1">
											...
											<div class="icon-box-info mt-1">
												...
												<p><?=$this->pocore()->call->posetting[8]['value'];?></p>
											</div>
										</div>
									</div>
									<div class="col-12 col-md-4 col-lg-12 mb-lg-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
										<div class="icon-box icon-box-style-1">
											...
											<div class="icon-box-info mt-1">
												...
												<p><a href="mailto:you@domain.com"><?=$this->pocore()->call->posetting[5]['value'];?></a></p>
											</div>
										</div>
									</div>
									<div class="col-12 col-md-4 col-lg-12 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
										<div class="icon-box icon-box-style-1">
											...
											<div class="icon-box-info mt-1">
												...
												<p><a href="tel:<?=$this->pocore()->call->posetting[6]['value'];?>"><?=$this->pocore()->call->posetting[6]['value'];?></a></p>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-8 appear-animation" data-appear-animation="fadeInRightShorter">
								<form role="form" id="contact_form"  class="contact-form form-style-2" method="post" onSubmit="return false">
									...
									<div class="form-row">
										<div class="form-group col">
											<input type="text" value="" data-msg-required="Please enter the subject." maxlength="100" class="form-control" name="company" id="company" placeholder="Subject" required>
										</div>
									</div>
									<div class="form-row">
										<div class="form-group col">
