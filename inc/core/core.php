 ...
 *
 *
 * Ini adalah file core eska yang memuat semua library penunjang.
 * This is a file core from eska which contains all the supporting libraries.
 *
 */
/**
 * Mendeklarasi Core Path eska
 *
 * Declaration Core Path eska
 *
 * Thanks to Mang Aay
 *
 */
...
/**
 * Memasukkan library utama eska
 *
 * Include eska library
 *
 */
...
/**
 * Menginisialisasi semua class dari eska dan vendor
 *
 * Initialize all class from eska and vendor
 *
 */
class PoCore {
    public $pdo;
    ...
    public function __construct() {
        ...
        /**
         * Menginisialisasi semua class dari eska dan vendor ke variabel
         *
         * Initialize all class from eska and vendor to variabel
         *
         */
        $this->pdo = null;
    ...
    public function setlang($component, $lang) {
        if (file_exists("core/lang/" . $component . "/" . $lang . ".php")) {
            if (VQMOD == TRUE) {
                include_once VQMod::modCheck("core/lang/main/" . $lang . ".php");
                include_once VQMod::modCheck("core/lang/" . $component . "/" . $lang . ".php");
                return $_;
            } else {
                include_once "core/lang/main/" . $lang . ".php";
                include_once "core/lang/" . $component . "/" . $lang . ".php";
                return $_;
            }
        } else {
            if (VQMOD == TRUE) {
                include_once VQMod::modCheck("core/lang/main/id.php");
                include_once VQMod::modCheck("core/lang/" . $component . "/id.php");
                return $_;
            } else {
                include_once "core/lang/main/id.php";
                include_once "core/lang/" . $component . "/id.php";
                return $_;
            }
        }
    }
