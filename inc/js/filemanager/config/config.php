...
$medium_width = $medium_size[0];
$medium_height = $medium_size[1];

$str_po = $_SERVER['PHP_SELF'];
$strlink_po = preg_replace("/\/inc\/js\/filemanager\/(dialog\.php$)/","",$str_po);
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => $strlink_po.'/core/uploads/',
	/*
	|--------------------------------------------------------------------------
	...
	*/
	...
	'relative_image_creation_width'           => array( $medium_width ), //width of image (you can leave empty if you set height)
	'relative_image_creation_height'          => array( $medium_height ), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
